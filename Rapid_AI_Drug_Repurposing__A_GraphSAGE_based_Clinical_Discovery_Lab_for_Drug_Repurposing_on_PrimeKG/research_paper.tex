...
\toprule
\textbf{Candidate Drug} & \textbf{Primary Indication} & \textbf{Predicted Indication} & \textbf{Intermediary Biological Mechanism} & \textbf{Literature Support} & $\mathbf{\hat{y}_{uv}}$ \\
\midrule
...
Menatetrenone & Secondary osteoporosis & Traumatic bone fracture & Osteocalcin $\gamma$-carboxylation \& mineral matrix binding & Clinical trial~\cite{ref_vk2} & 0.998 \\
Anakinra & Rheumatoid arthritis & Fracture non-union repair & IL-1R1 blockade of hyper-inflammatory osteoclastogenesis & Mechanistic~\cite{ref_il1} & 0.996 \\
Mecasermin & Primary IGF-1 deficiency & Tibial bone union & Direct IGF-1R tyrosine kinase activation \& chondrogenesis & Preclinical & 0.999 \\
\bottomrule
\end{tabular}%
}
\end{table*}
